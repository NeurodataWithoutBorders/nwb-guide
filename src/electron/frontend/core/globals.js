...
export const guidedProgressFilePath = joinPath(
  appDirectory,
  ...paths.subfolders.progress,
);

export const previewSaveFolderPath = joinPath(
  appDirectory,
  ...paths.subfolders.preview,
);
export const conversionSaveFolderPath = joinPath(
  appDirectory,
  ...paths.subfolders.conversions,
);

export const testDataFolderPath = joinPath(
  appDirectory,
  ...paths.subfolders.testdata,
);
...
export const ENCRYPTION_KEY = isElectron
  ? Buffer.concat(
      [Buffer.from(appDirectory), Buffer.alloc(KEY_LENGTH)],
      KEY_LENGTH,
    )
  : "";
