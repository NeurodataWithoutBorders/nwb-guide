...
export class ContactPage extends Page {
  ...
  updated() {
    let contact_lottie_container = (this.shadowRoot ?? this).querySelector(
      "#contact-us-lottie",
    );
            ...
            <div class="dc_con">
              ...
              <div class="docu-content-container">
                <h2 class="document_text">
                  If you encounter any issues or have requests for new features,
                  please create a new
                  <a
                    target="_blank"
...
customElements.get("nwbguide-contact-page") ||
  customElements.define("nwbguide-contact-page", ContactPage);
