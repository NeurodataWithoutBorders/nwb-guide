      ...
      <div class="guided--dataset-card">
        ...
        <div class="guided--dataset-card-body">
          ...
          <div class="guided--dataset-card-row">
            ...
            <h1 class="guided--text-dataset-card ml-sm-1">
...
customElements.get("nwb-progress-card") ||
  customElements.define("nwb-progress-card", ProgressCard);
