  ...
  render() {
    ...
    <header id="guided-header-div" class="guided--header">
      ...
      ${this.sections.map(
        (section, i) => html`
          <div
            class="guided--progression-tab guided--progression-tab-triangle ${i ===
            this.selected
              ? `selected-tab`
              : ""}"
...
customElements.get("nwb-guided-header") ||
  customElements.define("nwb-guided-header", GuidedHeader);
