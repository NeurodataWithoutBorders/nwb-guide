...
export class OptionalSection extends LitElement {
  ...
  updated() {
    if (this.value === undefined)
      this.shadowRoot.querySelector(".optional-section__content").hidden = true;
...
customElements.get("nwb-optional-section") ||
  customElements.define("nwb-optional-section", OptionalSection);
