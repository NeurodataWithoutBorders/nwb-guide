  ...
  render() {
    ...
    return html`
      ...
      >
        ...
        ${dialog
          ? ""
          : html`<br /><small>Cannot get full ${this.type} path on web distribution</small>`}
      </button>
    `;
  }
}

customElements.get("nwb-filesystem-selector") ||
  customElements.define("nwb-filesystem-selector", FilesystemSelector);
