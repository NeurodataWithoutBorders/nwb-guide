...
import AxonaLFPDataInterfaceSchema from '../../../../../../schemas/json/generated/AxonaLFPDataInterface.json'
...
globalStateCopy.schema.source_data.properties.AxonaLFPDataInterface = AxonaLFPDataInterfaceSchema.properties.AxonaLFPDataInterface
...
export const AxonaLFPDataInterface = PageTemplate.bind({});
const AxonaLFPDataInterfaceGlobalCopy = JSON.parse(JSON.stringify(globalState))
AxonaLFPDataInterfaceGlobalCopy.interfaces.interface = AxonaLFPDataInterface
AxonaLFPDataInterfaceGlobalCopy.schema.source_data = AxonaLFPDataInterfaceSchema
AxonaLFPDataInterface.args = { activePage, globalState: AxonaLFPDataInterfaceGlobalCopy };
