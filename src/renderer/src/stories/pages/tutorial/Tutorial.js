    ...
    render() {
        ...
        return html` 
                ...
                ${hasEntry(tutorialPipelineName)
                    ? html`<div>
                        <p>
                            A dataset has been generated for you at <small><code><a @click=${() => shell?.showItemInFolder(entry.project.initialized)}>${entry.project.initialized}</a></code></small> 
                        ...
                        <p>
                            And remember, <b>the more you provide Global Metadata, the less you'll have to specify later.</b>
                        </p>
                        ...
                        ${new InspectorListItem({
                            ...
                            <small>When you reach the Upload page, make sure to provide a Dandiset ID on the <b>DANDI Staging server</b>
                            — just so we don't overrun the main server with test data.</small>`,
                            type: 'warning',
                        })}
                        </div>
