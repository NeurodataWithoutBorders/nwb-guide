...
get_current_collections_model = api.model(
    "currCollections",
    {
...
class datasetCollection(Resource):
    ...
    curr_collections_parse.add_argument(
        "selected_account",
        type=str,
        required=True,
        help="The target account to work with.",
        location="args",
    )
    ...
    upload_collection_parse.add_argument(
        "selected_account",
        type=str,
        required=True,
        help="The target account to work with.",
    ...
    upload_collection_parse.add_argument(
        ...
        type=list,
        required=True,
        help="List of the collection tag ids",
        location="json",
    )
    ...
    @api.doc(
        responses={
            200: "Success",
            403: "User is not owner or manager to dataset",
            500: "There was an internal server error",
            400: "Bad request",
        },
        description="Returns the updated list of updated collection names and ids.",
    )
    ...
    parser_remove_collections.add_argument(
        "selected_account",
        type=str,
        required=True,
        help="The target account to work with.",
