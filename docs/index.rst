...
The resulting files are fully compliant with the best practices expected of the ::dandi-archive::`dandi-archive <Distributed Archives for Neurophysiology Data Integration (DANDI)>`_.
