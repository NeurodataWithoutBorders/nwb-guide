...
We should also indicate the ``sex`` of each subject since this is a requirement for `uploading to the DANDI Archive <https://docs.dandiarchive.org/user-guide-sharing/validating-files/#missing-dandi-metadata>`_.
