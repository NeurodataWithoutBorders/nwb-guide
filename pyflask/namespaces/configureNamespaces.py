...
def configure_namespaces():
    ...
    manage_datasets_namespace = Namespace(
        NamespaceEnum.MANAGE_DATASETS.value,
        description="Routes for handling manage datsets functionality",
    )
    ...
    curate_datasets_namespace = Namespace(
        NamespaceEnum.CURATE_DATASETS.value,
        description="Routes for handling dataset curation",
    )
    namespaces[NamespaceEnum.CURATE_DATASETS] = curate_datasets_namespace

    disseminate_datasets_namespace = Namespace(
        NamespaceEnum.DISSEMINATE_DATASETS.value,
        description="Routes for handling dataset dissemination",
    )
    namespaces[NamespaceEnum.DISSEMINATE_DATASETS] = disseminate_datasets_namespace

    prepare_metadata_namespace = Namespace(
        NamespaceEnum.PREPARE_METADATA.value,
        description="Routes for handling metadata preparation",
    )
    namespaces[NamespaceEnum.PREPARE_METADATA] = prepare_metadata_namespace

    organize_datasets_namespace = Namespace(
        NamespaceEnum.ORGANIZE_DATASETS.value,
        description="Routes for handling dataset organization",
    )
    ...
    taxonomy_namespace = Namespace(
        NamespaceEnum.TAXONOMY.value,
        description="Routes for handling taxonomy functionality",
    )
    ...
    datasets_namespace = Namespace(
        NamespaceEnum.DATASETS.value,
        description="Routes for handling dataset functionality",
    )
