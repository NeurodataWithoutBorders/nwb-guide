...
pennsieveAPIKeyAndSecret = api.model(
...
class PennsieveAPIKeyAndSecret(Resource):
    ...
    api_key_parser.add_argument(
        ...
        type=str,
        required=True,
        help="API key from the Pennsieve platform",
        location="json",
    )
    ...
    @api.doc(
        responses={
            ...
            400: "Username or password are incorrect",
        }
    )
...
model_status_options = api.model(
    "StatusOptions",
    {
...
model_get_dataset_status_response = api.model(
    "GetDatasetStatusResponse",
    {
        "status_options": fields.List(
            fields.Nested(model_status_options),
            required=True,
...
class BfChangeDatasetStatus(Resource):
    ...
    parser_change_dataset_status.add_argument(
        ...
        type=str,
        required=True,
        help="The selected bfdataset id or name.",
        location="json",
    )
    parser_change_dataset_status.add_argument(
        "selected_status",
        type=str,
        required=True,
        help="The target status for the dataset.",
        location="json",
    )

    @api.marshal_with(successMessage, False, 200)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
    ...
    def put(self):
        ...
        api.logger.info(
            f" bf_change_dataset_status --  args -- selected_bfaccount: {selected_bfaccount} selected_bfdataset: {selected_bfdataset} selected_status: {selected_status}"
        )
    ...
    parser_dataset_status.add_argument(
        "selected_account",
        type=str,
        required=True,
        help="The selected bfaccount.",
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Get the status of a dataset and available statuses.",
    )
...
class BfAccountList(Resource):
    ...
    @api.doc(
        responses={500: "There was an internal server error"},
        description="Returns a list of the user's accounts stored in the system.",
    )
    def get(self):
        try:
...
class BfDefaultAccountLoad(Resource):
    ...
    @api.doc(
        responses={500: "There was an internal server error"},
        description="Returns the first valid account as the default account. Usually SODA-Pennsieve.",
    )
    def get(self):
        try:
...
users_response_model = api.model(
    "Users",
    {
        "users": fields.List(
            fields.String,
            required=True,
            description="List of the accounts in the user's organization.",
        ),
    },
)
...
class BfGetUsers(Resource):
    ...
    parser_get_users.add_argument(
        ...
        required=True,
        location="args",
        help="The account to get associated users for.",
    )

    @api.marshal_with(users_response_model, False, 200)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns a list of the users in the given Pennsieve Account's organization.",
    )
...
model_bf_get_teams_response = api.model(
    "BfGetTeamsResponse",
    {
        "teams": fields.List(
            fields.String,
            required=True,
            description="List of the teams in the user's organization.",
        )
    },
)
...
class BfGetTeams(Resource):
    ...
    parser_get_teams.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve inter-organization teams for.",
    )

    @api.marshal_with(model_bf_get_teams_response, False, 200)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns a list of the teams in the given Pennsieve Account's organization.",
    )
    def get(self):
        try:
            # get the selected account out of the request args
...
model_account_details_response = api.model(
    "AccountDetailsResponse",
    {
        "account_details": fields.String(
            required=True,
            description="The email and organization for the given Pennsieve account.",
        ),
        "organization_id": fields.String(
            required=True,
            description="The organization id for the given Pennsieve account.",
        ),
    },
)
...
class BfAccountDetails(Resource):
    ...
    parser_account_details.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve details for.",
    )

    @api.marshal_with(model_account_details_response, False, 200)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the email and organization for the given Pennsieve account.",
    )
...
model_pennsieve_agent_response = api.model(
    "PennsieveAgentResponse",
    {
        "agent_version": fields.String(
            required=True,
            description="The version number of the installed Pennsieve Agent.",
        ),
    },
)
...
class CheckAgentInstall(Resource):
    ...
    @api.doc(
        responses={
            500: "There was an internal server error",
            400: "Pennsieve Agent is not installed",
        },
        description="Returns the Pennsieve Agent version if it is installed.",
    )
    def get(self):
...
model_account_dataset = api.model(
    "AccountDataset",
    {
...
model_account_datasets_list_response = api.model(
    "AccountDatasetsResponse",
    {
        "datasets": fields.List(
            fields.Nested(model_account_dataset),
            required=True,
            description="List of the datasets in the user's organization.",
        ),
    },
)
...
class BfDatasetAccount(Resource):
    ...
    parser_dataset_account.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve datasets for.",
    )

    @api.marshal_with(model_account_datasets_list_response, False, 200)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns a list of the datasets the given Pennsieve account has access to.",
    )
...
class DatasetSubtitle(Resource):
    ...
    parser_dataset_subtitle.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve the dataset subitle for.",
    )
    parser_dataset_subtitle.add_argument(
        "selected_dataset",
        type=str,
        required=True,
        location="args",
        help="The name or id of the dataset to retrieve the subtitle for.",
    )
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the subtitle for the given dataset.",
    )
    def get(self):
    ...
    parser_add_dataset_subtitle.add_argument(
        "input_subtitle",
        type=str,
        required=True,
        location="json",
        help="The subtitle to add to the dataset.",
    )
    ...
    @api.doc(
        ...
        description="Adds a subtitle to the given dataset.",
    )
    def put(self):
...
class DatasetDescription(Resource):
    ...
    parser_dataset_description.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve the dataset description for.",
    )
    parser_dataset_description.add_argument(
        "selected_dataset",
        type=str,
        required=True,
        location="args",
        help="The name or id of the dataset to retrieve the description for.",
    )
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the description for the given dataset.",
    )
    def get(self):
    ...
    parser_add_dataset_description.add_argument(
        "input_description",
        type=str,
        required=True,
        location="json",
        help="The description to add to the dataset.",
    )
    ...
    @api.doc(
        ...
        description="Adds a description to the given dataset.",
    )
    def put(self):
...
model_get_permissions_team = api.model(
    "GetPermissionsTeam",
    {
...
model_get_permissions_response = api.model(
    "GetPermissionsResponse",
    {
        "permissions": fields.List(
            fields.String,
            required=True,
            description="A list of the users/organizations/teams and their roles (viewer, manager, owner, etc) for the given dataset.",
        ),
        "team_ids": fields.List(
            fields.Nested(model_get_permissions_team),
            required=True,
            description="A list of the team ids for the given dataset.",
        ),
    },
)
...
class DatasetPermissions(Resource):
    ...
    parser_dataset_permissions.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
        help="The target account to retrieve the dataset permissions for.",
    )
    parser_dataset_permissions.add_argument(
        "selected_dataset",
        type=str,
        required=True,
        location="args",
        help="The name or id of the dataset to retrieve the permissions for.",
    )
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the permissions for the given dataset. Permissions are a list of the users/organizations/teams and their roles (viewer, manager, owner, etc) for the given dataset. Format: ['organization: org_name, role: viewer', 'user: username, role: manager]",
    )
    def get(self):
    ...
    parser_add_dataset_permissions.add_argument(
        "scope",
        type=str,
        required=True,
        location="args",
        help="Defines who or what will have their permissions for the dataset changed. Options are: team or user.",
    )
    parser_add_dataset_permissions.add_argument(
        "input_role",
        type=str,
        required=True,
        location="json",
        help="The permissions to add to the dataset. Can be either: owner, manager, viewer, remove current permissions.",
    )
    parser_add_dataset_permissions.add_argument(
        "name",
        type=str,
        required=True,
        location="args",
        help="The name of the team or user to change permissions for.",
    )
    ...
    @api.doc(
        ...
        description="Adds permissions to the given dataset. Permissions are a list of the users/organizations/teams and their roles (viewer, manager, owner, etc) for the given dataset.",
    )
    def patch(self):
...
class scaleBannerImage(Resource):
    ...
    parser_image.add_argument(
        ...
        required=True,
        location="json",
        help="The file path of the image to be resized.",
    )

    @api.doc(
        responses={500: "There was an internal server error"},
        description="Scale an image to be under 5Mb in size.",
    )
...
class BfBannerImage(Resource):
    ...
    parser_banner_image.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
        help="The target account to retrieve the banner image for.",
    )
    parser_banner_image.add_argument(
        "selected_dataset",
        type=str,
        required=True,
        location="args",
        help="The name or id of the dataset to retrieve the banner image for.",
    )
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the AWS URI for the dataset banner image.",
    )
    def get(self):
    ...
    parser_add_banner_image.add_argument(
        "input_banner_image_path",
        type=str,
        required=True,
        location="json",
        help="File path to the local banner image. Will be uploaded to AWS.",
    )
    ...
    @api.doc(
        ...
        description="Adds a banner image to the given dataset. The banner image will be uploaded to AWS.",
    )
    def put(self):
...
model_get_license_response = api.model(
    "GetLicenseResponse",
    {
...
class BfLicense(Resource):
    ...
    parser_license.add_argument(
        ...
        required=True,
        location="args",
        help="The target account to retrieve the license for.",
    )
    parser_license.add_argument(
        "selected_dataset",
        type=str,
        required=True,
        location="args",
        help="The name or id of the dataset to retrieve the license for.",
    )
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Returns the license for the given dataset.",
    )
    def get(self):
    ...
    parser_add_license.add_argument(
        "input_license",
        type=str,
        required=True,
        location="json",
        help="License for the dataset.",
    )
    ...
    @api.doc(
        ...
        description="Adds a license to the given dataset.",
    )
    def put(self):
...
class BfRenameDataset(Resource):
    ...
    parser_rename_dataset.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
        help="The target account to rename the dataset for.",
    )
    parser_rename_dataset.add_argument(
        "selected_dataset",
        type=str,
    ...
    parser_rename_dataset.add_argument(
        ...
        required=True,
        location="json",
        help="The new name for the dataset.",
    )
    ...
    @api.doc(
        ...
        description="Renames the given dataset.",
    )
    def put(self):
...
model_get_username_response = api.model(
    "GetUsernameResponse",
    {
        "username": fields.String(
            required=True,
            description="The current SODA user's first and last name stored in the Pennsieve system.",
        )
    },
)
...
class BfGetUsername(Resource):
    ...
    @api.doc(
        ...
        description="Retrieves the current SODA user's first and last name stored in the Pennsieve system.",
    )
    ...
    parser_add_username.add_argument(
        "keyname",
        type=str,
        required=True,
        location="json",
        help="Name of the account to be associated with the given credentials.",
    )
    parser_add_username.add_argument(
        "key",
        type=str,
        required=True,
        location="json",
        help="The API key the user generated on Pennsieve.",
    )
    parser_add_username.add_argument(
        "secret",
        type=str,
        required=True,
        location="json",
        help="The API secret the user generated on Pennsieve.",
    )
    ...
    @api.doc(
        ...
        description="Adds account username to the Pennsieve configuration file.",
    )
...
class BfAddAccountApiKey(Resource):
    ...
    @api.doc(
        ...
        description="Adds account to the Pennsieve configuration file. Used when connecting account to Pennsieve with an API key and secret.",
    )
    @api.marshal_with(successMessage, 200, False)
    def put(self):
...
class BfCreateDatasetFolder(Resource):
    ...
    parser_create_dataset_folder.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
    ...
    @api.doc(
        ...
        description="Creates a new dataset on the Pennsieve platform.",
    )
    ...
    parser_submit_dataset.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
    ...
    parser_submit_dataset.add_argument(
        ...
        required=True,
        location="json",
        help="The local data/dataset folder that will upload to the target dataset.",
    )
    ...
    @api.doc(
        ...
        description="Add data to an existing dataset entity on the Pennsieve platform.",
    )
    def put(self):
        from pennsieve.api.agent import AgentError
...
class BfGetUploadProgress(Resource):
    @api.doc(
        responses={500: "There was an internal server error"},
        description="Get the progress of the upload.",
    )
...
model_upload_details_response = api.model(
    "UploadDetailsResponse",
    {
        ...
        "upload_folder_count": fields.Integer(
            required=True, description="The number of folders that have been uploaded."
        ),
    },
)
...
class BfSubmitDatasetUploadDetails(Resource):
    @api.doc(
        responses={500: "There was an internal server error"},
        description="Get the upload details required for logging the upload session correctly.",
    )
...
class BfGetDatasetReadme(Resource):
    ...
    parser_readme.add_argument(
        ...
        required=True,
        location="json",
        help="The updated readme content to save.",
    )
    ...
    @api.doc(
        ...
        description="Update the readme for a dataset.",
    )
    @api.marshal_with(successMessage, False, 200)
    ...
    parser_readme_get.add_argument(
        "selected_account",
        type=str,
        required=True,
        location="args",
    ...
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Get the readme for a dataset.",
    )
...
class BfGetDatasetTags(Resource):
    ...
    parser_tags.add_argument(
        ...
        required=True,
        location="args",
        help="The account to get dataset tags for.",
    )

    @api.expect(parser_tags)
    @api.doc(
        responses={500: "There was an internal server error", 400: "Bad request"},
        description="Get the tags for a dataset.",
    )
    ...
    parser_tags_put.add_argument(
        "tags",
        type=list,
        required=True,
        location="json",
        help="The tags to add to the dataset.",
    )
    ...
    @api.doc(
        ...
        description="Add tags to a dataset.",
    )
    @api.marshal_with(successMessage, False, 200)
    def put(self, dataset_name_or_id):
