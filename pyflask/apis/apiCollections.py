...
from collectionsDataset import get_all_collections, upload_new_names
...
organizationCollections = api.model(
    "collectionDataset",
    {
...
class organizationCollections(Resource):
    ...
    parser_new_names.add_argument(
        ...
        type=str,
        required=True,
        help="The target dataset to work with.",
        location="args",
    )
    parser_new_names.add_argument(
        "collection",
    ...
    @api.doc(
        description="Method for creating new collection names on Pennsieve",
        responses={
            200: "Success",
